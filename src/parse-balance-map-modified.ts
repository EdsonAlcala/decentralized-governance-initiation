...
import BalanceTreeModified from './balance-tree-modified'
...
interface MerkleDistributorInfoModified {
    merkleRoot: string
    tokenTotal: string
    claims: {
        [account: string]: {
...
export function parseBalanceMapModified(balances: OldFormat | NewFormat[]): MerkleDistributorInfoModified {
    ...
    // construct a tree
    const tree = new BalanceTreeModified(
